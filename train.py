...
import os
from import_keras import preprocess_input, image
...
from toolkit import MultiboxLoss, BBoxUtility
...
callbacks = [keras.callbacks.ModelCheckpoint('./saved/weights.{epoch:02d}-{val_loss:.2f}.hdf5',
                                             verbose=1,
